...
//        logger.info("Running test >> shouldAddNewMessage");
//        //before
...
//
//        channelsMessageDto.setChannel(channelDto.getIdChannel());
//        channelsMessageDto.setContent(content);
//        channelsMessageDto.setSender(senderDto.getIdUser());
...
//        Assert.assertEquals(channel.getIdChannel(), addedMessages.getChannel());
//        Assert.assertEquals(sender.getIdUser(), addedMessages.getSender());
...
//        logger.info("Running test >> shouldGetConversation");
//        //before
//        //create necessary channel
